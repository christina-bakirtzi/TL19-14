...
class AvsFDateAdapter(private val myDataset: List<AvsF_response_date>) :
    RecyclerView.Adapter<AvsFDateAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t12).text = myDataset[position].actualTotalLoadValue
