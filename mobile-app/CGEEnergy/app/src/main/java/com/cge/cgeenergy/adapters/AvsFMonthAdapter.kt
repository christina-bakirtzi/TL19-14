...
class AvsFMonthAdapter(private val myDataset: List<AvsF_response_month>) :
    RecyclerView.Adapter<AvsFMonthAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t11).text = myDataset[position].actualTotalLoadByDayValue
