...
import com.cge.cgeenergy.models.AvsF_response_month
...
class AvsFMonthActivity : AppCompatActivity() {


    private lateinit var avsfMonthResponseList: List<AvsF_response_month>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chart)

        avsfMonthResponseList = DataManager.avsfMonthResponse
        populateGraphData()
...
//        at.text = avsfMonthResponseList[0].areaName+" ("+avsfMonthResponseList[0].mapCode +") "
//        setUpListView()
    }
...
//
//        var titleobject = AvsF_response_month()
...
//
//
//        (avsfMonthResponseList as MutableList).add(0, titleobject)
//
//        var viewAdapter = AvsFMonthAdapter(avsfMonthResponseList)
//
...
//    }
    fun populateGraphData() {
        ...
        var i=1
//        xAxisValues.add("")
        for(value in avsfMonthResponseList){
            xAxisValues.add(value.day)
            yValueGroup1.add(BarEntry(i.toFloat(),value.dayAheadTotalLoadForecastByDayValue.toFloat()))
            yValueGroup2.add(BarEntry(i.toFloat(),value.actualTotalLoadByDayValue.toFloat()))
//            xAxisValues.add("")
            i=i+1
        }
        ...
        val size = avsfMonthResponseList.size.toFloat() +avsfMonthResponseList.size.toFloat()
