...
class AggregatedYearAdapter(private val myDataset: List<Aggregated_response_year>) :
    RecyclerView.Adapter<AggregatedYearAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t9).text = myDataset[position].productionType
        holder.view.findViewById<TextView>(R.id.t10).text = myDataset[position].actualGenerationOutputByMonthValue
