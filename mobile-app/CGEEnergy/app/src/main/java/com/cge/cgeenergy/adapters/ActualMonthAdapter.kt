...
class ActualMonthAdapter(private val myDataset: List<Actual_response_month>) :
    RecyclerView.Adapter<ActualMonthAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t10).text = myDataset[position].actualTotalLoadByDayValue
