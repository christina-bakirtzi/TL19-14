...
class ActualYearAdapter(private val myDataset: List<Actual_response_year>) :
    RecyclerView.Adapter<ActualYearAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t9).text = myDataset[position].actualTotalLoadByMonthValue
