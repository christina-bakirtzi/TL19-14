...
class DayYearAdapter(private val myDataset: List<Day_response_year>) :
    RecyclerView.Adapter<DayYearAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t10).visibility = View.GONE
