...
class AvsFYearAdapter(private val myDataset: List<AvsF_response_year>) :
    RecyclerView.Adapter<AvsFYearAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t9).text = myDataset[position].dayAheadTotalLoadForecastByMonthValue
        holder.view.findViewById<TextView>(R.id.t10).text = myDataset[position].actualTotalLoadByMonthValue
