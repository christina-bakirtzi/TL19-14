...
class AggregatedDateAdapter(private val myDataset: List<Aggregated_response_date>) :
    RecyclerView.Adapter<AggregatedDateAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.view.findViewById<TextView>(R.id.t11).text = myDataset[position].productionType
        holder.view.findViewById<TextView>(R.id.t12).text = myDataset[position].actualGenerationOutputValue
        holder.view.findViewById<TextView>(R.id.t13).text = myDataset[position].updateTimeUTC
