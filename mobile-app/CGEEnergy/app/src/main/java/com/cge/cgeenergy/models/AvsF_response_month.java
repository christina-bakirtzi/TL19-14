...
public class AvsF_response_month {
        ...
        @Expose
        private String day;
        @SerializedName("DayAheadTotalLoadForecastByDayValue")
        @Expose
        private String dayAheadTotalLoadForecastByDayValue;
        ...
        public String getDayAheadTotalLoadForecastByDayValue() {
            return dayAheadTotalLoadForecastByDayValue;
        }

        public void setDayAheadTotalLoadForecastByDayValue(String dayAheadTotalLoadForecastByDayValue) {
