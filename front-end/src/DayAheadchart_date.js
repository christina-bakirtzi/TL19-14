...
class DayAheadchart_date extends Component {    constructor(props){
    super(props);
    this.state = {
        chartData: {
...
static defaultProps = {
            ...
            <Bar
                ...
                options={{
                    ...
                    title:{
                        ...
                        text: 'Day Ahead Total Load Forecast in '+this.state.country+' ('+this.state.mapcode+') on '+this.state.day+'/'+this.state.month+'/'+this.state.year,
                        fontSize:25
                    },
                    legend:{
 ...
 export default DayAheadchart_date;