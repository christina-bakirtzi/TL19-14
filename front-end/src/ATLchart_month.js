...
class ATLchart_month extends Component {    constructor(props){
    super(props);
    this.state = {
        chartData: {
            ...
            <Bar
                ...
                options={{
                    ...
                    title:{
                        ...
                        text: 'Actual Total Load in '+this.state.country+' ('+this.state.mapcode+') on '+this.state.month+'/'+this.state.year,
                        fontSize:25
                    },
                    legend:{
