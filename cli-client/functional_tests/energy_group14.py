...
@click.option('--timeres', '-t', required=True, type=str, help = 'Timeres for the data, can be one of PT15M, PT30M or PT60M')
@optgroup.group('Date', cls=RequiredMutuallyExclusiveOptionGroup, help = 'Date of interest, can be either a date of the form YYYY-MM-DD, month of form YYYY-MM or year of form YYYY')
...
@click.option('--format', '-f', default='json', help =  'Format in which the data appears, can be either json (default) or csv')
...
@click.option('--productiontype', '-pt', required=True, type = click.Choice(ptList) , help = 'Production type, must be written inside " " ')
@optgroup.group('Date2', cls=RequiredMutuallyExclusiveOptionGroup, help = 'Date of interest, can be either a date of the form YYYY-MM-DD, month of form YYYY-MM or year of form YYYY')
@optgroup.option('--date', '-d', type=click.DateTime(formats=["%Y-%m-%d"]))
@optgroup.option('--month', '-m', type=click.DateTime(formats=["%Y-%m"]))
@optgroup.option('--year', '-y', type=click.DateTime(formats=["%Y"]))
@click.option('--format', '-f', default='json', help = 'Format in which the data appears, can be either json (default) or csv')
...
@click.option('--area', '-a', required=True, help = 'Area of interest')
@click.option('--timeres', '-t', required=True, help = 'Timeres for the data, can be one of PT15M, PT30M or PT60M')
@optgroup.group('Date3', cls=RequiredMutuallyExclusiveOptionGroup, help = 'Date of interest, can be either a date of the form YYYY-MM-DD, month of form YYYY-MM or year of form YYYY')
@optgroup.option('--date', '-d', type=click.DateTime(formats=["%Y-%m-%d"]))
@optgroup.option('--month', '-m', type=click.DateTime(formats=["%Y-%m"]))
@optgroup.option('--year', '-y', type=click.DateTime(formats=["%Y"]))
@click.option('--format', '-f', default='json', help = 'Format in which the data appears, can be either json (default) or csv')
...
@click.option('--area', '-a', required=True, help = 'Area of interest')
@click.option('--timeres', '-t', required=True, help = 'Timeres for the data, can be one of PT15M, PT30M or PT60M')
@optgroup.group('Date4', cls=RequiredMutuallyExclusiveOptionGroup, help = 'Date of interest, can be either a date of the form YYYY-MM-DD, month of form YYYY-MM or year of form YYYY')
@optgroup.option('--date', '-d', type=click.DateTime(formats=["%Y-%m-%d"]))
@optgroup.option('--month', '-m', type=click.DateTime(formats=["%Y-%m"]))
@optgroup.option('--year', '-y', type=click.DateTime(formats=["%Y"]))
@click.option('--format', '-f', default='json', help = 'Format in which the data appears, can be either json (default) or csv')
...
@optgroup.option('--newdata', '-nd', type=str, help = 'Type of data to be added to the DataBase, can be one of ActualTotalLoad, AggregatedGenerationPerType or DayAheadTotalLoadForecast')
